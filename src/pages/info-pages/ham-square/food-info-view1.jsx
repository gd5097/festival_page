...
import image2 from '../../../images/ham1-2.jpg';
import image3 from '../../../images/ham1-3.jpg';
import image4 from '../../../images/ham1-4.jpg';
    ...
    const navigate = useNavigate();
     ...
     const food = {
        ...
        menu: [
            ...
            {
                foodName: '데리야끼 (데리야끼+마요네즈+카레가루)',
                foodCost: 3500,
            },
            {
                foodName: '핵불닭 A (데리야끼+마요네즈+카레가루)',
                foodCost: 3500,
            },
            {
                foodName: '핵불닭 B (데리야끼+허니머스타드+마요네즈)',
                foodCost: 3500,
            },
            {
                foodName: '깻잎닭',
            ...
            {
                foodName: '치즈닭 A (데리야끼+치즈+치즈시즈닝)',
                foodCost: 4000,
            },
            {
                foodName: '치즈닭 B (핵불닭맛+치즈+치즈시즈닝)',
                foodCost: 4000,
            },
        ],
     }
